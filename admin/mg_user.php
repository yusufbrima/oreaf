...
<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<nav class="menu menu--francisco">
								<ul class="nav navbar-nav menu__list">
									...
									<li class="menu__item menu__item--current"><a href="mg_user" class="menu__link"><span class="menu__helper"><span class="glyphicon glyphicon-user-group"></span> Manage Users</a></li>
	...
	<div class="container">
		<table class="table table-striped" border="0">
			<caption class="h3">List of Users available</caption>
			<tbody>
				<?php
				if(isset($_REQUEST['flag'])AND !empty($_REQUEST['flag'])){
					...
					$Success .= "<strong>Transaction Result<br /></strong>Account removed successfully</div>";
					echo $Success;
					}
				?>
				<tr><th>Username</th><th>Email</th><th>Telephone</th><th>Join Date</th><th>Account Type</th></tr>
				<!-- <tr><td>lordadam</td><td>lordadam@gmakflsd.com</td><td>Tuesday 29th of August 2017 08:18:05 AM</td><td>Railtor <a href="#" data-href="mg_user?u_id=1233&c_f=HlNHLJs44" data-toggle="modal" data-target="#delete_user_modal"><span class="glyphicon glyphicon-trash"></span></a></td></tr> -->
				<?php
						$query =  "select username,join_date,email,user_type,phone,id from user order by join_date";
						if($conn->checkQuery($query)){
							...
							for($i=0;$i<$count;$i++){
							    ...
							    $date_output = strtotime($row['join_date']);
      							...
      							$phone =  $row['phone'];
      							$userid = $row['id'];
      							$account_type = ($row['user_type']==1)?"Requestor":"Railtor";
      							echo "<tr><td>$username</td><td>$email</td><td>$phone</td><td>$date_output</td><td>$account_type <a href=\"#\" data-href=\"mg_user?u_id=$userid&c_f=HlNHLJs44\" data-toggle=\"modal\" data-target=\"#delete_user_modal\"><span class=\"glyphicon glyphicon-trash\"></span></a></td></tr>";
      						}
						}
				  ?>
			</tbody>
...
<?php
	...
	include_once("lib/delete_user_modal.php");
