...
if(is_array(admin::retrieve_profile($user_id,$conn->conn))){
	$result_set = admin::retrieve_profile($user_id,$conn->conn);
	$date_output = strtotime($result_set['join_date']);
...
<!-- Collect the nav links, forms, and other content for toggling -->
	...
	<!--banner-->
		<div class="banner1">
		<div class="container">
			<h3 class="animated wow slideInLeft" data-wow-delay=".5s"><a href="dashboard">Home</a> / <span>Profile</span></h3>
		</div>
	</div>
	<!--banner-->
	<!--Template body-->
    ...
    <div class="popular-grids single">
					...
					<div class="col-md-12 popular-grid">
						<h4><?php echo $result_set['fullname']; ?> <!-- <span class="pull-right"><a href='#' data-toggle='modal' data-target='#profile_edit'><span class='glyphicon glyphicon-pencil'>&nbsp;Edit</span></a></span> --></h4>
						<!-- <img src="../images/avatar.png" class="img-responsive pull-right" alt=""> -->
						<?php echo "<img src='".$fullpath."'class='img-responsive pull-right'/>";?>
						<div class="popular-text pull-left">
							<div class="detail-bottom">
								<p><?php echo $result_set['email']; ?></p>
								<ul>
									<li class="text-info">Username: </li>
									<li class="text-info1"><?php echo $result_set['username']; ?></li>
									<div class="clearfix"></div>
								</ul>
								<ul>
									<li class="text-info">Date Registered :</li>
									<li class="text-info1"><?php echo $date_output; ?></li>
									<div class="clearfix"></div>
								</ul>
								<ul>
									<li class="text-info">Contact Information :</li>
									<li class="text-info1">+232301405978</li>
									<div class="clearfix"></div>
								</ul>
							</div>
						</div>
