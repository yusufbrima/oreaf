...
<html>
<head>
<title>Online Real Estate Application::Login</title>
<!--css-->
...
<!-- Collect the nav links, forms, and other content for toggling -->
	...
	<!--banner-->
		<div class="banner1">
		<div class="container">
			<h3 class="animated wow slideInLeft" data-wow-delay=".5s"><a href="index">Home</a> / <span>Login</span></h3>
		</div>
	</div>
	<!--banner-->
<!--signin-->
			<div class="login-grids">
						<div class="login">
							<div class="login-right">
							    <form action="bin/login" method="post" id="login">
									<h3>Sign In</h3>
									<!-- Successful registration message  -->
									<?php
											if(isset($_SESSION['userRegistration'])){
												unset($_SESSION['userRegistration']);
												$Success = "<div class='alert alert-success noprint'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>";
			                  $Success .= "<strong>Success Message<br /></strong>Registration Completed successfully</div>";
			                  echo $Success;
											}
									 ?>
									 <?php
											 if(isset($_SESSION['password_reset'])){
												 ...
												 $Success = "<div class='alert alert-success noprint'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>";
												 $Success .= "<strong>Success Message<br /></strong>Account password reset successfully</div>";
												 echo $Success;
											 }
										?>
									 <?php
			                   ...
			                   echo $error;
			 						 ...
			 						 ?>
									<input type="text" name="Username" placeholder="Enter your username" value="<?php if(isset($_COOKIE['username'])){ echo strip_tags($_COOKIE['username']);}?>" autofocus />
									<input type="password" name="valPassword" placeholder="Password"  />
									<h4><a href="password_reset">Forgot password?</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="register">New Here Create an Account?</a></h4>
									<div class="single-bottom">
									<input type="checkbox"  id="brand" value="" checked="true">
