...
if(is_array($profile_picture_result_set) AND !empty($profile_picture_result_set)){
	$display_flag =true;
...
<html>
<head>
<title>Online Real Estate Application::Railtor Home Page</title>
<!--css-->
...
<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<nav class="menu menu--francisco">
								<ul class="nav navbar-nav menu__list">
									...
									<li class="menu__item"><a href="post" class="menu__link"><span class="menu__helper"><span class="glyphicon glyphicon-envelope"></span> Posts <span class="badge badge-primary"><?php echo $total_post; ?></span></a></li>
	...
	<!--banner-->
		<div class="banner1">
		<div class="container">
			<h3 class="animated wow slideInLeft" data-wow-delay=".5s"><a href="index">Home</a> / <span>Railtor Home Page</span></h3>
		</div>
	</div>
	<!--banner-->
					...
					<div class="col-md-12 popular-grid">
						...
						<div class="transaction-text pull-right">
							<div class="detail-bottom">
								...
								<ul class="dashboard">
									<li class="text-info">Received(s): </li>
									<li class="text-info1">
										<div class="count hvr-bounce-to-bottom">
