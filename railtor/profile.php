...
$total_request = 0;
$total_post  = 0;
$profile_display = railtor::retrieve_profile($userid,$conn->conn);
...
<!-- Start of single profile view -->
    ...
    <div class="popular-grids single">
					...
					<div class="col-md-12 popular-grid">
						<h4><?php echo ($display_flag==true)?$profile_display['fullname']:"N/A"; ?> <span class="pull-right"><a href='#' data-toggle='modal' data-target='#profile_edit_modal'><span class='glyphicon glyphicon-pencil'>&nbsp;Edit</span></a></span></h4>
