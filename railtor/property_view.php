...
<html>
<head>
<title>Online Real Estate Application::Settings</title>
<!--css-->
...
<!-- Collect the nav links, forms, and other content for toggling -->
    ...
    <div class="popular-grids single">
					...
					<div class="col-md-12 popular-grid">
						<h4>Owner Email: <?php echo ($property_display_flag==true)?$property_resultset['email']:"N/A"; ?></h4>
						...
						<div class="popular-text pull-left">
							...
							<div class="detail-bottom">
								...
								<ul>
									<li class="text-info">Owner :</li>
									<li class="text-info1"><?php echo ($property_display_flag==true)?$property_resultset['fullname']:"N/A"; ?></li>
									<div class="clearfix"></div>
								</ul>
								<ul>
								...
								<!-- <button class="button btn-primary" data-toggle='modal' data-target='#property_request'>Request</button> -->
							</div>
						</div>
					</div>
