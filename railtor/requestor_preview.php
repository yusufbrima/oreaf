...
if(count($profile_picture_result_set)!=0){
	$display_flag =true;
...
$requestor_display_flag = false;
$requestor_display_result_set = NULL;
$total_request = 0;
$total_post  = 0;
$sanitizer =  new sanitizer();
$requestor_fullpath = "../upload/";
if(isset($_REQUEST['r_id'])&&!empty($_REQUEST['r_id'])){
   $railtor_id = $sanitizer->sanitize($_REQUEST['r_id']);
   $requestor_display_result_set = railtor::retrieve_requestor_profile($railtor_id,$conn->conn);
   if(count($requestor_display_result_set)!=0){
   	$requestor_display_flag = true;
   	$requestor_fullpath .=$requestor_display_result_set['profilePicture'];
   	$date_output = strtotime($requestor_display_result_set['join_date']);
...
<html>
<head>
<title>Online Real Estate Application::Add Profile</title>
<!--css-->
...
<!-- Collect the nav links, forms, and other content for toggling -->
	...
	<!--banner-->
		<div class="banner1">
		<div class="container">
			<h3 class="animated wow slideInLeft" data-wow-delay=".5s"><a href="index">Home</a> / <span>Requestor Preview</span></h3>
		</div>
	</div>
	<!--banner-->
	<!--Template body-->
<!-- Start of single profile view -->
    ...
    <div class="popular-grids single">
					...
					<div class="col-md-12 popular-grid">
						<h4><?php echo ($requestor_display_flag==true)?$requestor_display_result_set['fullname']:"N/A"; ?></h4>
						<!-- <img src="../images/avatar.png" class="img-responsive pull-right" alt=""> -->
						<?php echo ($requestor_display_flag==true)?"<img src='".$requestor_fullpath."'class='img-responsive pull-right'/>":'<img src="../images/avatar.png"  class="img-responsive pull-right"/>'; ?>
						<div class="popular-text pull-left">
							<div class="detail-bottom">
								<p><?php echo ($requestor_display_flag==true)?$requestor_display_result_set['email']:"N/A"; ?></p>
								<ul>
									<li class="text-info">Address: </li>
									<li class="text-info1"><?php echo ($requestor_display_flag==true)?$requestor_display_result_set['address']:"N/A"; ?></li>
									<div class="clearfix"></div>
								</ul>
								<ul>
									<li class="text-info">Username: </li>
									<li class="text-info1"><?php echo ($requestor_display_flag==true)?$requestor_display_result_set['username']:"N/A"; ?></li>
									<div class="clearfix"></div>
								</ul>
								<ul>
									<li class="text-info">City / Town: </li>
									<li class="text-info1"><?php echo ($requestor_display_flag==true)?$requestor_display_result_set['city']:"N/A"; ?></li>
									<div class="clearfix"></div>
								</ul>
								<ul>
									<li class="text-info">District: </li>
									<li class="text-info1"><?php echo ($requestor_display_flag==true)?$requestor_display_result_set['district']:"N/A"; ?></li>
									<div class="clearfix"></div>
								</ul>
								<ul>
									<li class="text-info">Region: </li>
									<li class="text-info1"><?php echo ($requestor_display_flag==true)?$requestor_display_result_set['region']:"N/A"; ?></li>
									<div class="clearfix"></div>
								</ul>
								<ul>
									<li class="text-info">Date Registered :</li>
									<li class="text-info1"><?php echo ($requestor_display_flag==true)?$date_output:"N/A"; ?></li>
									<div class="clearfix"></div>
								</ul>
								<ul>
									<li class="text-info">Contact Information :</li>
									<li class="text-info1"><?php echo ($requestor_display_flag==true)?$requestor_display_result_set['tel']:"N/A"; ?></li>
									<div class="clearfix"></div>
								</ul>
							</div>
						</div>
