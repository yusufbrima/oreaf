					...
					<div class="head-top customer-top">
						...
						<div class="deatils">
							<ul>
								...
								<li><i class="glyphicon glyphicon-log-out" aria-hidden="true"><a href='#' data-href='logout' data-toggle='modal' data-target='#logoutmodal'>Logout <?php echo $username; ?></a></li>
...
<!-- Collect the nav links, forms, and other content for toggling -->
	...
	<!--banner-->
		<div class="banner1">
		<div class="container">
			<h3 class="animated wow slideInLeft" data-wow-delay=".5s"><a href="index">Home</a> / <span>Settings Pane</span></h3>
		</div>
	</div>
	<!--banner-->
	<!--Template body-->
